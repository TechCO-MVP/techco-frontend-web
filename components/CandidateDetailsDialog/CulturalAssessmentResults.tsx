      ...
      <div className="mb-8">
        ...
        <div className="mt-6 rounded-lg bg-blue-50 p-4">
          ...
          <p className="text-gray-700">
            El candidato muestra un buen equilibrio entre habilidades técnicas y
            soft skills, con particular fortaleza en liderazgo y trabajo en
            equipo.
          </p>
        </div>
