...
export function OnboardingStepper({
  ...
  return (
    <div className="mx-auto flex h-[512px] w-[579px] flex-col items-center gap-[18px] border-b-[5px] border-b-talent-orange-500 bg-white shadow-lg">
      ...
      <div className="flex w-full flex-row justify-center gap-4 pb-6">
        ...
        {!isLast ? (
          ...
          >
            {isFirst ? "Iniciar recorrido" : "Siguiente"}
          </Button>
        ) : (
          <Button
            variant="default"
